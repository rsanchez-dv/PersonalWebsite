<template>
  <div class="container">
    ...
    <div>
      <h2>Context</h2>
      <span class="subTitle">What is Whatfits?</span>
      <p>Whatfits is a web application to create a community of gym goers where we focus on encouragement to
        improve one's health through social exercise as part of our senior design project. Our main goal is to
        use motivation and community to help people adopt healthy habits by having users find others with similar
        skill levels and based on location. We designed this project during our fall 2017 semester which included
        the requirements need to achieve this, design documentaion, technology specification document,
        project plan, design document, and test plan document. The following semester was used to implement these
        designs
        to meet the deadline of May 2018 as an agile team. Whatfits was a collaborative effort between Aaron Pham,
        Abram Villanueva, George Cheng, Longcheng Chi, and Roberto Sanchez.
      </p>
    </div>
    <div>
      <h2>Using Power of the Internet</h2>
      <span class="subTitle">Trying to create a community for all</span>
      <p>The main objective for the class is to create a unique web application where we as students can design and
        build a
        solution to a problem that exists in the world. For us we decided to create a community for people to find
        others to
        workout since people are social creatures and creating a tool to help them socialize will create a positive
        feedback
        loop that encourages people to be physically active. Project idea was originally created by Aaron Pham and
        later expanded
    ...
    <div>
      ...
      <p>Current online applications focus more on people with experience working out or just cataloging workouts such
        ...
        phone and delivered to your house) it
        has become a challenge to get people moving. Modern conviences gave us a very sedentary life style, add in
    ...
    <div>
      <h2>Reality</h2>
      <span class="subTitle">What is project planning and resource management?</span>
      <p>During the design phase we where encourage to add features to make our application more unique however we
        failed to
        grasp what was possible with 3-4 months of development especally if its our first attempt at a web application
        with that
        many features. We had to negotiate with our instructor to trim back our backlog to a more managable backlog
        capable of being
        completed by the May deadline. In addition we where losing two people from our team of 7, so we had to make
        some cuts.
      </p>
      <p>Here is a short list of cool features that we had to either scale back or straight out cut.
        <br>
        <ul>
          <li>Paid Coaches (CUT) - A method of getting trainers to sell their services on our platform for a revenue
            stream.</li>
          <li>Logging and Archiving (CUT) - Due to the current scope of the project we won't be needed this until a
            certain freshold is achieved.</li>
          <li>Usage Analysis Dashboard (CUT) - Current scope has aproximately 150 - 200 users so this is not a
            priority.</li>
          <li>Biometrics (CUT) - No integration with Fitbit or other health devices.</li>
          <li>Team Builder (CUT) - Our attempt to create sports teams based on people in your area.</li>
          <li>Calorie Tracker (CUT) - A way to input what you ate and track the calories.</li>
          <li>Workout Logger (TRIMMED) - We only focused on a handful of workouts such as cardio (biking and running)
            and weightlifting.</li>
          <li>Event Manager (CUT) - A system to create events and to find events such as marathons or sport events to
            participate in.</li>
      ...
      <p>So after all that we still had quite alot to develop but we were confident we could accomplish this by the
        deadline.
        <br>
        Here is what is going to be built:
        <ul>
          <li>Registration</li>
          ...
          <li>Chat</li>
          <li>Friends List</li>
          <li>Administator Console (User Management)</li>
          <li>Single Sign On Capabilities (Scope Creep #1)</li>
    ...
    <div>
      <h2>Development</h2>
      <span class="subTitle">When project planning is critical</span>
      <h3>Set up</h3>
      <p>Development technically started around the beginning of Januaray after winter break was ending however we
        already
        set up the server on Amazon Web Services (AWS) to host a sample html website with a SSL certificate to learn
        the ins and outs
        of hosting on a Windows Server and using Internet Information System (IIS). We also created the Github
        repository ready
        for hosting our project. </p>
      <h3>Getting Started</h3>
      <p>We began setting up both the Vue.js project and WebAPI project on our Github and began developing key
        components of
        our application such as the database and registration of users. For our first sprint we set ourselves in
        features that
        did not depend on any others since we needed all team members working on something and not waiting for others
        to finish their
      ...
      <h3>Moving on</h3>
      <p>Sprint 2 went much easier and we where able to meet the deadline for this sprint since by then we manage to
        get key components working together. Unfortunatly we
        lost a team member and had to scale back some items such as the Single Sign On functionality.
      </p>
    ...
    <div>
      ...
      <p>After 4 months in development Whatfits was officially deployed during our live deployment presentation on our
        last
        day of school. During that presentation we where to show how we deployed it, deployed the database, and set up
        IIS to host
      ...
      <p>Built and designed by Abram Villanueva, for registration we need the following data inorder to get a user to
        ...
        <br>
        <ul>
          <li>Username - Authentication Reasons</li>
          <li>Password - Authentication Reasons</li>
          <li>Full Name - User Profile</li>
          <li>Address - For Searching</li>
          <li>Skill Level - User Profile and Searching</li>
          <li>3 Security Questions and Answers - Password Recovery</li>
        </ul>

        Username is suppose to be unique and is a way for finding other users. Password is utilizing <a href="https://haveibeenpwned.com/Passwords">Troy
          Hunt's database</a><i class="fa fa-link" aria-hidden="true"></i> to verify if your password is
        vulnerable.Typing in a weak or generic password will display a warning message and prevent user from
        registering. We believe this is a better approach than generating an arbitrary password with bewildering
        requirements (i.e. Those passwords that want at least 2 capitalized letters ,1 number, and 1 special
        character.)
        The address is being checked against <a href="https://developers.google.com/maps/documentation/geocoding/start">
      ...
      <p>That concludes all the features for this web application.</p>
